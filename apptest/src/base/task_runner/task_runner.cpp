...
void task_runner::post_task(task::callback_type callback, task::delay_type delay) {
...
void task_runner::post_task(task::callback_type callback, task::run_time_type run_time) {
